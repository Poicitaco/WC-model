...
<div class="hint-bar">
<span><kbd>← →</kbd> Prev/Next</span>
<span><kbd>R</kbd> Reset Timer</span>
<span><kbd>Esc</kbd> Close</span>
<span style="color:#6e7681">Drag header to move · Drag bottom-right to resize</span>
...
(function(){
  ...
  function update(n) {
    ...
    notesBody.innerHTML = note || '<span class="empty">(No script added for this slide)</span>';
  ...
  document.getElementById('reset-layout').addEventListener('click', function(){
    if (confirm('Reset default card layout?')) {
